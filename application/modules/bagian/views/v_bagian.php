...
<?php } else { ?>
    ...
    <script>
        ...
        function showForm(id = null) {
            ...
            if (id == null) {
                $("#id_bagian_soal").val("");
                $("#bagian_soal").val("");
                $("#title_addedit").html('<h2>Tambah Data : Bagian Soal</h2>');
                $("#btn").html('Simpan');
            }
        }
        ...
        function editData(id, bagian_soal) {
            $("#id_bagian_soal").val(id);
            $("#bagian_soal").val(bagian_soal);
            $("#title_addedit").html('<h2>Edit Data : Bagian Soal</h2>');
            $("#btn").html('Update');
            showForm(id);
        }
    </script>
    ...
    <div class="body clearfix">
        <div class="x_panel col-sm-12">
            <div class="x_title">
                <h2><small>Pg: </small><b>Daftar bagian_soal</b></h2>
                ...
                <div class="row">
                    <?php if (($akun[0]->zp[0] == "1") || ($akun[0]->zp[2] == "1")) { ?>
                        <div class="col-sm-12" id="pnladd">
                            <div class="col-sm-12" style="background: #D3D3D3;">
                                <form class="" action="<?php echo base_url() . 'bagian/simpan_data'; ?>" method="post" novalidate="">
                                    <!-- spacebar -->
                                    <div style="width: 100%; height:7px; border: 0px solid white;"></div>
                                    <span class="section" id="title_addedit">Data Bagian Soal</span>
                                    <div class="field item form-group">
                                        <label class="col-form-label col-md-2 col-sm-2 label-align">bagian_soal<span class="required"> *</span></label>
                                        <div class="col-md-8 col-sm-8">
                                            <input class="form-control" data-validate-length-range="4" data-validate-words="2" id="bagian_soal" name="bagian_soal" placeholder="ex. minggu" required="required">
                                            <input type="hidden" id="id_bagian_soal" name="id_bagian_soal">
                                        </div>
                                    </div>
                                    <div class="ln_solid">
                    ...
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            ...
                            <?php } ?>
                            <?php echo form_open('bagian/delete_data'); ?>
                                ...
                                <tbody>
                                    ...
                                    foreach ($data as $i) {
                                        ...
                                        <tr>
                                            <?php if ($akun[0]->zp[4] == "1") { ?>
                                                <td>
                                                    <input type="checkbox" <?= $i->ada; ?> class="chkCheckBoxId filled-in chk-col-red" value="<?php echo $i->id_bagian_soal; ?>" name="id_bagian_soal[]" id="<?php echo $no; ?>" onclick="cekit(<?php echo $no; ?>)" />
                                            ...
                                            <?php if ($akun[0]->zp[2] == "1") { ?>
                                                <td>
                                                    <button type="button" <?= $i->ada; ?> class="btn btn-success btn-circle" onclick="editData(<?php echo $i->id_bagian_soal; ?>,'<?php echo $i->bagian_soal; ?>');"><i class="glyphicon glyphicon-pencil"></i></button>
                                                </td>
                                            <?php } ?>
                                        </tr>
                                    <?php } ?>
