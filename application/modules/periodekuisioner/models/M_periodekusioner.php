...
class M_periodekuisioner extends CI_Model
{
    ...
    public function getData()
    {
        ...
        pku.id_pkuesioner,pku.tmt,pku.tst,concat(ta.tmt_tahun_ajaran,' / ',ta.tst_tahun_ajaran) as tahun_ajaran,ta.status_tahun_ajaran as status_ta,pp.id_semester,pp.status as status_semester,
        IF(
    ...
    where ta.id_tahun_ajaran=pp.id_tahun_ajaran
    and pp.id_periode_perkuliahan=pku.id_periode_perkuliahan
    and pku.id_pkuesioner != 0
    GROUP BY
         pku.id_pkuesioner
    ORDER BY
